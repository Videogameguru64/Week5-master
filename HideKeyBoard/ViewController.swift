...
//    }
    ...
    // 12) Modify btnView functions. Goes to position in ScrollView where the btnBack
    ...
    @IBAction func btnSave(sender: UIButton) {
        ...
        if (txtFirst.text=="" || txtLast.text=="" || txtEmail.text=="" || txtAddress.text=="" || txtState.text=="" || txtCity.text=="" || txtZip.text=="" || txtPhone.text=="" )
        {
